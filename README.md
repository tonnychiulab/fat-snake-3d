...
核心系統
渲染引擎：Canvas 2D API，利用 createRadialGradient 模擬 3D 球體光照
粒子系統：自訂 Particle 類別，支援重力、旋轉、淡出
動畫循環：requestAnimationFrame + Delta Time 幀率獨立
碰撞偵測：基於網格座標的精確碰撞檢測
蛇身渲染：尾到頭繪製，每段獨立計算大小、顏色、搖擺動畫
